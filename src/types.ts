...
export interface State {manualCredits?:ManualCredit[];version:1;duration:number;initialBand:number;profile:Profile;logs:Log[];active:Active|null;deferred:Record<string,number>;catalog?:Catalog;bands?:Record<string,number[]>;accounts?:Record<string,AccountProgress>}
